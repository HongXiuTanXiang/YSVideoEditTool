#
# Be sure to run `pod lib lint WAVideoBox.podspec' to ensure this is a
...
TODO: Add long description of the pod here.
  ...
  s.source_files = 'WAVideoBox/Classes/**/*'
  
  # s.resource_bundles = {
  #   'WAVideoBox' => ['WAVideoBox/Assets/*.png']
  # }
